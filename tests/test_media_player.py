...
import pytest
from pytest_homeassistant_custom_component.common import AsyncMock, MockUser
...
from custom_components.music_assistant.media_player import MusicAssistantPlayer
...
async def test_media_player_join_players_action(
    ...
    with pytest.raises(
        ...
        match=r"media_player\.blah_blah is not a Music Assistant media player",
    ):
        await hass.services.async_call(
            MEDIA_PLAYER_DOMAIN,
            SERVICE_JOIN,
